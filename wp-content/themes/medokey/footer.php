        ...
        <div class="container">
            <div class="footer-top">
                    <div class="footer__logo logo">
                        <a class="logo__link" href="#"><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/logo.svg'"></a>
                </div>

                <div class="footer__nav-left nav">
                    <ul class="nav__list">
                ...
                <div class="footer__nav-right nav">
                    <ul class="nav__list">
                ...
                <div class="footer__info-block">
                    <div class="call-block">
                        <a class="tel tel-footer" href="tel:+74994600781">+7 (499) 460-07-81</a>
                        <button class="call-block__btn call-block__btn-footor">Обратный звонок</button>
                    </div>
                    <div class="time-work">
                        <span>Пн-Пт с 7:00 до 22:00</span>
                        <span>Сб-Вс с 9:00 до 21:00</span>
                    </div>
                    <div class="location">Москва, Зубовский бульвар, 25
                ...
                <div id="accordion" class="accordion">
                    <div class="accordion__item">
                        ...
                        <div class="accordion__body">
                            <ul class="nav__list accordion__content">
                                <li class="nav__item"><a class="nav__link" href="">Стоимость</a></li>
                                <li class="nav__item"><a class="nav__link" href="">Доставка</a></li>
                                <li class="nav__item"><a class="nav__link" href="">Оплата</a></li>
                                <li class="nav__item"><a class="nav__link" href="">Отзывы</a></li>
                        ...
                        <div class="accordion__body">
                            <div class="accordion__content">
                                <div class="contact__inner">
                                    ...
                                    <div class="location">
                                        <span>Время работы</span>
                                        <span>Москва, Зубовский бульвар, 25
                                            (метро Парк Культуры)</span>
                                        <a class="location__link" href="">Посмотреть на карте</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="footer-bottom">
                <div class="copyright"> Copyright 2022 MED-OK - Медицинские справки, оформление медицинских документов
                </div>
